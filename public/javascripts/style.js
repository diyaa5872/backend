...
var switchdropp=document.querySelector(".switch");

function switchdiv(){
    if(dropp.style.width==="25%"){
        dropp.style.div="0%";
        switchdropp.style.div="15%";
    }
    if(dropp.style.display==="block"){
        dropp.style.display="none";
        switchdropp.style.display="block";
    }
}

function backdiv(){
    if(switchdropp.style.width==="15%"){
        switchdropp.style.width="0%";
        dropp.style.width="25%";
    }
    if(switchdropp.style.display==="block"){
        switchdropp.style.display="none";
        dropp.style.display="block";
    }
}
